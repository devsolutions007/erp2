...
<link rel="stylesheet" href="{{ asset('cashdesk/css/pos_style.css') }}">

<link rel="stylesheet" href="{{ asset('cashdesk/template/css/style.css') }}">
<!--  custom societe css -->
<link rel="stylesheet" href="{{ asset('societe/css/custom.css') }}">
<!-- main custom style -->
<!-- <link rel="stylesheet" href="cashdesk/css/style.css') }}"> -->
<link rel="stylesheet" href="{{ asset('cashdesk/css/w3_style.css') }}">
